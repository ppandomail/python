# Dada una concesionaria de autos, 5 clientes van a pedir un auto, debe preguntalre
# Nombre y apellido del comprador, marca, puertas y color.
# Marcas posibles y sus precios:
#  Ford 100M, Chevrolet 120M y Fiat 180M
# Por la cantidad de puertas se agrega un precio:
# 2 50M, 4 65M y 5 78M
# Dependiendo del color se deben sumar:
# blanco 10M, azul 20M y negro 30M
